...
- Audit time: 2026-08-16T06:08:06.437Z
...
- General source-catalog records outside this curated scope: 1425 cards / 8131 observations; card and observation scopes still reconcile exactly.
...
| arena_code_webdev | 115 | 1 | 114 | 46 | 0 | 46 | 46 | VALID |
...
Total effective Arena observations: 562; sum of 13 unique available counts: 562; conservation: PASS.

## Catalog provenance

- Cards: 1789 (AA 607, Arena 439, OpenRouter 743)
- Available observations: 10751 (AA 6562, Arena 2703, OpenRouter 1486)
- Provenance / source ownership findings: 0
- Unproven default 0 / 50 values: 0
- Full live three-source refresh: no
- Source input modes:
  - arena: official-arena-raw-extraction — 439 cards, 2703 available observations (direct_source_extraction)
  - artificial_analysis: official-aa-structured-snapshot — 607 cards, 6562 available observations (official_source_snapshot)
  - openrouter: 3d/1w stabilized endpoint medians, followed by an equal-weight mean across current OpenRouter Standard endpoints; raw current rows, auxiliary traffic-weighted mean, median, quartiles, and range retained in the verified snapshot — 362 cards, 724 available observations (official_source_snapshot)
  - openrouter: official-openrouter-local-snapshot — 381 cards, 762 available observations (official_source_snapshot)
...
- arena: WebDev source changes may be legitimate, but the recorded full-source snapshot does not have the expected 116 / 1 / 115 audit facts.
